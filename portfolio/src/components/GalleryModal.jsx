      ...
      <div className="modal-box">
        ...
        >
          ...
          <div className="ms-after">
            <img src={getOptimizedMediaUrl(current.after, 1200)} alt="After" className="ms-img" draggable={false} />
          </div>

          {/* BEFORE (Top layer, clipped from the right) */}
          <div className="ms-before" style={{ clipPath: `inset(0 ${100 - pct}% 0 0)` }}>
            <img src={getOptimizedMediaUrl(current.before, 1200)} alt="Before" className="ms-img" draggable={false} />
          </div>
